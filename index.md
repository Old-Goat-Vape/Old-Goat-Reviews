        ...
        <main class="flex-grow container mx-auto px-4 py-8 md:py-12">
            ...
            <section class="bg-gray-800 rounded-xl shadow-lg p-6 md:p-10 mb-12 text-center border border-gray-700">
                ...
                <p class="text-lg md:text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                    Welcome to the no-nonsense corner of the internet where <a href="https://thevapeworkshop.com" target="_blank" rel="noopener noreferrer" class="text-orange-500 hover:text-orange-600 underline">vape gear</a> gets judged like it owes me money. From <a href="https://thevapeworkshop.com/forums/viewforum.php?f=19" target="_blank" rel="noopener noreferrer" class="text-orange-500 hover:text-orange-600 underline">flavor concentrates</a> to <a href="https://thevapeworkshop.com/forums/viewforum.php?f=19" target="_blank" rel="noopener noreferrer" class="text-orange-500 hover:text-orange-600 underline">hardware</a>, if it doesn't vape right — you'll hear about it. No fluff, no filler, just the brutal truth… Old Goat style.
                </p>
                <p class="text-lg md:text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                    Pull up a chair, pack your RDA, and <a href="https://thevapeworkshop.com" target="_blank" rel="noopener noreferrer" class="text-orange-500 hover:text-orange-600 underline">join the herd</a> on The Vape Workshop forum.
                </p>
                <h3 class="text-2xl font-bold text-white mb-4">🧠 Start Browsing My Categories:</h3>
                <div class="flex flex-wrap justify-center gap-4">
                    <a href="https://thevapeworkshop.com/forums/viewforum.php?f=19" target="_blank" rel="noopener noreferrer" class="bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 px-6 rounded-full shadow-md transition-all duration-300 transform hover:scale-105 flex items-center justify-center">
        ...
        <footer class="bg-black text-white py-6 px-4 md:px-10 mt-12">
            <div class="container mx-auto text-center text-sm">
                ...
                <p class="mt-2">
                    ...
                    <a href="https://thevapeworkshop.com" target="_blank" rel="noopener noreferrer" class="hover:text-orange-500 transition-colors duration-300">Visit The Vape Workshop</a>
                </p>
            </div>
        </footer>
